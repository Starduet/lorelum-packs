...
- Generated: 2026-09-17T07:25:04+00:00  |  lore 0.1.0-alpha.2  |  mode(s): keyword  |  top-k threshold: 3
- Store: tmp\eval-store-050  |  Queries: 165 runnable, 0 skipped
- Install source: `Starduet/lorelum-packs` fork Registry (pre-merge evaluation), ref `agentic-coding-v0.5.0` @ `48898f6`, tree identical to the PR branch

## keyword — gate PASSED (positive top-3 100.0% vs fixture minimum 90.0%)

- Positive queries: top-1 97.0% (99 queries), top-3 100.0%
